  ...
  useEffect(() => {
    const fetchAllData = async () => {
      try {
        ...
        const trendingIds = trendingResponse.data.coins
          .map((coin: TrendingCrypto) => coin.item.id)
          .join(",");
        ...
        const sortedByChange = [...mainData].sort(
          (a, b) =>
    ...
    switch (activeFilter) {
      ...
      case "metaverse":
        filtered = filtered.filter((crypto) =>
          crypto.tags?.includes("metaverse")
        );
        break;
      case "defi":
      ...
      case "stablecoins":
        filtered = filtered.filter((crypto) =>
          crypto.tags?.includes("stablecoin")
        );
        break;
      default:
        ...
        <div className="container mx-auto px-8 relative z-10">
          <div className="flex flex-col items-center text-center mb-12">
            ...
            <p className="text-lg text-gray-200 max-w-2xl animate-fade-in-up delay-100">
              Track real-time cryptocurrency prices, market caps, and trading
              volumes. Stay informed with live updates and market trends.
            </p>
          </div>
              ...
              <Table>
                <TableHeader>
                  <TableRow className="border-b border-gray-100">
                    ...
                    <SortableHeader field="price_change_24h">
                      24hr Change
                    </SortableHeader>
                    <SortableHeader field="price_change_percentage_24h">
                      % Change
                    </SortableHeader>
                    <SortableHeader field="market_cap">
                      Market Cap
                    </SortableHeader>
                  </TableRow>
                </TableHeader>
                <TableBody>
                  {filteredData.map((crypto) => (
                    ...
                    >
                      ...
                      <TableCell className="uppercase text-gray-500 font-medium">
                        {crypto.symbol}
                      </TableCell>
